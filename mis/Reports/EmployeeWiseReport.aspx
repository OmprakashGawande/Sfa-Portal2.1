<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="EmployeeWiseReport.aspx.cs" Inherits="mis_Reports_EmployeeWiseReport" %>
                                ...
                                <div class="col-md-12">
                                    <asp:GridView runat="server" AutoGenerateColumns="false" ID="dataGrid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total Time Spent" ItemStyle-CssClass="center-grid">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotalTimeSpent" runat="server" Text='<%# Eval("TotalTimeSpent") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="First Allocation Date" ItemStyle-CssClass="center-grid">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFirstAllocationDate" runat="server" Text='<%# Eval("FirstAllocationDate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Last Allocation Date" ItemStyle-CssClass="center-grid">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLastAllocationDate" runat="server" Text='<%# Eval("LastAllocationDate") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        $(document).ready(function () {
            ...
            initCustomDataTable('.datatable', 'Employee Wise Report', 'Employee Wise Report');
        });
    </script>
</asp:Content>
