<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UMRoleFormMap.aspx.cs" Inherits="mis_Admin_UMRoleFormMap" %>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="box">
                    ...
                    <div class="box-body">
                          <div class="card">
                                <div class="card-header">Role Form Mapping
                            </div>
                            <div class="card-body">
                                <div class="row">
                        <div class="col-md-3">
                                ...
                                <label>Role Name<span style="color: red;"> *</span></label>
                                 <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="rfv1" ValidationGroup="a"
                                                    ErrorMessage="Select Role Name" Text="<i class='fa fa-exclamation-circle' title='Select Role Name !'></i>"
                                                    ControlToValidate="ddlRole_Name" InitialValue="0" ForeColor="Red" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>
                                <asp:DropDownList ID="ddlRole_Name" runat="server" CssClass="form-control select2" ClientIDMode="Static" OnSelectedIndexChanged="ddlRole_Name_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                        ...
                        <asp:GridView ID="GridView1" DataKeyNames = "Form_ID" runat="server" class="table table-hover table-bordered" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Form_Name_E" HeaderText="Form Name" />
                                 <asp:BoundField DataField="Form_Name_H" HeaderText="Form Name(Hindi)" />
