<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UMFormMaster.aspx.cs" Inherits="mis_UserMgmt_UMFormMaster" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 pt-4" style="margin-top: 6px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <asp:LinkButton ID="lnkClear" OnClick="lnkClear_Click" Text="Reset" CssClass="btn btn-danger btn-block" runat="server"></asp:LinkButton>
                                            </div>
                                        </div>
                                            </div>
                                    </div>
